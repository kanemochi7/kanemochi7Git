...
<h1>KANEMOCHI<sub>Neo kakeibo 2017</sub></h1>

<div id="titles">
  <div id="titlecontent">

    <p class="center">EPISODE I<br />
      A NEW HOPE FOR YOUR MONEY</p>

    <p>消費が容易く、無駄遣いしやすい時代</p>
    
    <p>あなたはお金の管理に苦労したことありませんか。</p>
    
    <p>普通の家計簿に物足りなさを感じたことありませんか。</p>
    
    <p>このゲームは、あなたのために作られました！</p>

    <p>このゲームを作った人々をご紹介します。</p>
    
    <p>リーダのKYUHEE HONG <img id="ggyu" src="/kanemochi/resources/image/team_member/ggyu.png" class="team_member" /></p>
    
    <p> <img id="yhk" src="/kanemochi/resources/image/team_member/yhk.png" class="team_member" /> 家計簿開発のYOUNGHYUN KIM </p>
    
    <p>ゲーム開発のJAEHUN JEONG <img id="jh" src="/kanemochi/resources/image/team_member/jh.png" class="team_member" />　</p>
    
    <p>  <img id="ungc" src="/kanemochi/resources/image/team_member/ungc.png" class="team_member" />ゲーム開発のUNGSOO SHIN</p>
    
    <p>家計簿開発のGARAM PARK  <img id="ram" src="/kanemochi/resources/image/team_member/ram.png" class="team_member" /></p>
